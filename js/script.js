...
$("#rotate-4").on('click', function(){
    $(".front-4").css("z-index", "1");
    $(".back-4").css("z-index", "2");
})
$("#rotated-4").on('click', function(){
    $(".front-4").css("z-index", "2");
    $(".back-4").css("z-index", "1");
})

$("#rotate-5").on('click', function(){
    $(".front-5").css("z-index", "1");
    $(".back-5").css("z-index", "2");
})
$("#rotated-5").on('click', function(){
    $(".front-5").css("z-index", "2");
    $(".back-5").css("z-index", "1");
})
